/*Considere la siguiente relación de herencia, la cual involucra tres 
clases: Alumno, Deportista y BecadoDeporte. Esta última representa a 
aquellos alumnos que son deportistas y que por esa razón han recibido 
una beca especial del gobierno para premiar sus esfuerzos. Decida qué
atributos y métodos incluir de tal manera que su programa pueda:
...
g) Actualizar el monto de la beca de bdAna y bdCarmen. El dato dado por el
   usuario será el porcentaje de incremento de la beca actual. */
