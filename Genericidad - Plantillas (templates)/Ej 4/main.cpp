/*Ej4. Defina una plantilla para la clase Arreglo, la cual podrá definir
valores de distinto tipo, el cual se definirá en el momento de la instancia,
		...
		switch(opcion){
			case 1:
					if(arreglo1.arregloLleno()){
						...
						cout<<"\nDigite un elemento a agregar: "<<endl;
						cin>>elemento;
			...
			case 2: 
					if(arreglo1.arregloLleno()){
						...
						cout<<"El arreglo no esta lleno"<<endl;
					}
					break;
			case 3:
