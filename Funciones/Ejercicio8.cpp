/*8. Escriba una función nombrada cambio() que tenga un parámetro en
...
La función tiene que considerar el valor entero transmitido como una 
cantidad en dólares y convertir el valor en el número menor de billetes
equivalentes.*/
